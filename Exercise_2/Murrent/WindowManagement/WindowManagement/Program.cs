            ...
            WindowManager.Windows = new List<Window>
                {
                    ...
                    new WindowWithSigns { Content = "Window 2 wants to be a window, but will never be one because windows dont look like that. The only chance is to change the window immediately", ForegroundColor = ConsoleColor.Cyan, BackgroundColor = ConsoleColor.Red, Title = "Window Cyan/Red", Left = 0, Top = 0, Width = 15, Height = 10 },
